...
9. **Report** — list of filled documents + remaining stubs + paths of the notes created/updated by the environment check (`<BRAIN_COMMON>/facts/` always; `<BRAIN_TOOLS>` only when the tool inventory was opted in).
