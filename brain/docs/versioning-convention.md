...
- 🔴 **This document does not restate the vocabulary itself.** The canon is `docs/git-convention.md` (harness-owned since 2026-07-28); everything here points at it. A local copy is a local drift.
